...
const SignUpFormPageShop = () => {
  ...
  function uploaddata1() {
    ...
    data.append("upload_preset", "et3vfxvy");
    data.append("cloud_name", "dkl6osjli");
    fetch("https://api.cloudinary.com/v1_1/dkl6osjli/image/upload", {
      method: "post",
      body: data,
    })
    .then((res) => res.json())
  ...
  function uploaddata2() {
    ...
    data1.append("upload_preset", "et3vfxvy");
    data1.append("cloud_name", "dkl6osjli");
    fetch("https://api.cloudinary.com/v1_1/dkl6osjli/image/upload", {
      method: "post",
      body: data1,
    })
